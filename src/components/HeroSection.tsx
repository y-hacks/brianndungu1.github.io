...
const HeroSection = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: user?.email
        ? `mailto:${user.email}`
        : "mailto:brianndunguk003@gmail.com",
      label: "Email",
    },
  ];
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-muted-foreground mt-2">
              Please verify the GitHub username configuration.
            </p>
          </motion.div>
        ) : (
          <>
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-4">
                <span className="text-gradient">
                  {user?.name || user?.login || "Security Engineer"}
                </span>
              </h1>
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                Focused on reconnaissance, threat detection, vulnerability
                analysis, and securing cloud-native systems through offensive
            ...
            >
              ...
              <Button variant="heroOutline" size="xl" asChild>
                <a href="#projects">View Security Projects</a>
              </Button>
            </motion.div>
